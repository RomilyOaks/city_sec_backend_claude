  ...
  components: {
    ...
    schemas: {
      ...
      TokenRefreshRequest: {
        ...
        properties: {
          refreshToken: { type: "string", example: "ACCESS_TOKEN_EXAMPLE" },
        },
      },
      AuthTokensResponse: {
        type: "object",
      ...
      NovedadCreateRequest: {
        ...
        properties: {
          tipo_novedad_id: { type: "integer", example: 1 },
          subtipo_novedad_id: { type: "integer", example: 1 },
          fecha_hora_ocurrencia: { type: "string", example: "2025-12-18T12:00:00.000Z" },
          descripcion: { type: "string", example: "Incidente reportado" },
          localizacion: { type: "string", nullable: true },
          referencia_ubicacion: { type: "string", nullable: true },
          latitud: { type: "number", nullable: true, example: -12.0464 },
          longitud: { type: "number", nullable: true, example: -77.0428 },
          ubigeo_code: { type: "string", nullable: true, example: "150101" },
          origen_llamada: { type: "string", nullable: true, example: "Telefono" },
          reportante_nombre: { type: "string", nullable: true },
          reportante_telefono: { type: "string", nullable: true },
          reportante_doc_identidad: { type: "string", nullable: true },
          es_anonimo: { type: "boolean", nullable: true, example: false },
          observaciones: { type: "string", nullable: true },
          sector_id: { type: "integer", nullable: true, example: 1 },
          cuadrante_id: { type: "integer", nullable: true, example: 1 },
          prioridad_actual: { type: "string", nullable: true, example: "ALTA" },
          gravedad: { type: "string", nullable: true, example: "MEDIA" },
        },
      },
      NovedadUpdateRequest: {
        type: "object",
        properties: {
          tipo_novedad_id: { type: "integer", nullable: true },
          subtipo_novedad_id: { type: "integer", nullable: true },
          estado_novedad_id: { type: "integer", nullable: true },
          fecha_hora_ocurrencia: { type: "string", nullable: true },
          fecha_llegada: { type: "string", nullable: true },
      ...
      NovedadAsignarRecursosRequest: {
        type: "object",
        properties: {
          unidad_oficina_id: { type: "integer", nullable: true, example: 1 },
          vehiculo_id: { type: "integer", nullable: true, example: 1 },
          personal_cargo_id: { type: "integer", nullable: true, example: 1 },
          km_inicial: { type: "number", nullable: true, example: 0 },
        },
      },
    },
  },

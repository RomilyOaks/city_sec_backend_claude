/**
 * ============================================
 * RUTAS: src/routes/auditoria.routes.js
 * ============================================
 *
 * Rutas de Auditoría
...
router.get(
  ...
  auditoriaController.getEstadisticas
);
...
router.get(
  ...
  auditoriaController.getMiActividad
);
...
router.get(
  ...
  auditoriaController.exportarCSV
);
...
router.get(
  ...
  auditoriaController.getHistorialEntidad
);

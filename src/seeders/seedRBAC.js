...
async function seedRBAC() {
  ...
  try {
    ...
    const permisosData = [
      ...
      {
        modulo: "reportes",
        recurso: "operativos.vehiculares",
        accion: "read",
      ...
      {
        modulo: "reportes",
        recurso: "novedades.no_atendidas",
        accion: "read",
